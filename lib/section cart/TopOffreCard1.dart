...
//
//class TopOffreCard1 extends StatelessWidget {
...
//                  children: [
//    
//                    Text(Drink.title, style: TextStyle(fontWeight:FontWeight.bold),),
//    
...
//              child: Text(Drink.price, style: TextStyle(fontWeight:FontWeight.bold,fontSize: 30),),
//            ),
//
//
//      ],
